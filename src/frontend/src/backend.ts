...
import type { Category as _Category, Product as _Product, ProductId as _ProductId, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getMyOrders(arg0: UserId): Promise<Array<Order>> {
        if (this.processError) {
            try {
    ...
    async getProductsBySearchAndCategory(arg0: string, arg1: string): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProductsBySearchAndCategory(arg0, arg1);
                return from_candid_vec_n12(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async placeOrder(arg0: UserId, arg1: Array<[ProductId, bigint]>, arg2: bigint): Promise<void> {
        if (this.processError) {
            try {
